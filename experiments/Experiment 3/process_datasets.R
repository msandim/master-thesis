...
for(dname in names(datasets))
{
  ...
  write.csv(dataset,
            paste0("experiments/Experiment 3/datasets_processed/", dname, ".csv"),
            row.names = FALSE)
  ...
  for(i in 1:10)
  {
    ...
    write.csv(dataset_train,
              paste0("experiments/Experiment 3/datasets_processed/", dname, "_", sprintf("%02d", i), "_train.csv"),
              row.names = FALSE)
    
    write.csv(dataset_test,
              paste0("experiments/Experiment 3/datasets_processed/", dname, "_", sprintf("%02d", i), "_test.csv"),
              row.names = FALSE)
  }
}